...
public final class SegmentFormat {
    ...
    /** 8-byte segment magic. PLACEHOLDER — confirm before M1 sign-off (changing it is a format break). */
    public static final byte[] MAGIC = "ARENAFMT".getBytes(StandardCharsets.US_ASCII);
