 ...
 *   <li><b>{@code arena.varlen_bytes} is a per-batch budget for the whole column</b>, not per row —
 ...
 *       uses.</li>
 *   <li><b>{@code arena.sort_key} declares the natural sort order</b> ({@code sym} then {@code ts}),
...
public final class DemoSchemas {
    ...
    /**
     * Columns in {@code arena.sort_key} order — the sort the cold tier should write files in.
