// GENERATED by dev/update_flatbuffers.sh from format/Layout.fbs (flatcc v0.6.2) — DO NOT EDIT.
// The flatcc runtime it compiles against is the one vendored via nanoarrow
// (src/vendor/nanoarrow/, same flatcc version).
...
#define flatbuffers_identifier "ALD2"
#ifndef flatbuffers_extension
#define flatbuffers_extension "bin"
#endif


typedef const struct io_ascham_flatbuf_ColumnLayout_table *io_ascham_flatbuf_ColumnLayout_table_t;
typedef struct io_ascham_flatbuf_ColumnLayout_table *io_ascham_flatbuf_ColumnLayout_mutable_table_t;
typedef const flatbuffers_uoffset_t *io_ascham_flatbuf_ColumnLayout_vec_t;
typedef flatbuffers_uoffset_t *io_ascham_flatbuf_ColumnLayout_mutable_vec_t;
typedef const struct io_ascham_flatbuf_LayoutDescriptor_table *io_ascham_flatbuf_LayoutDescriptor_table_t;
typedef struct io_ascham_flatbuf_LayoutDescriptor_table *io_ascham_flatbuf_LayoutDescriptor_mutable_table_t;
typedef const flatbuffers_uoffset_t *io_ascham_flatbuf_LayoutDescriptor_vec_t;
typedef flatbuffers_uoffset_t *io_ascham_flatbuf_LayoutDescriptor_mutable_vec_t;
#ifndef io_ascham_flatbuf_ColumnLayout_file_identifier
#define io_ascham_flatbuf_ColumnLayout_file_identifier "ALD2"
#endif
/* deprecated, use io_ascham_flatbuf_ColumnLayout_file_identifier */
#ifndef io_ascham_flatbuf_ColumnLayout_identifier
#define io_ascham_flatbuf_ColumnLayout_identifier "ALD2"
#endif
#define io_ascham_flatbuf_ColumnLayout_type_hash ((flatbuffers_thash_t)0xf58c92e8)
#define io_ascham_flatbuf_ColumnLayout_type_identifier "\xe8\x92\x8c\xf5"
#ifndef io_ascham_flatbuf_ColumnLayout_file_extension
#define io_ascham_flatbuf_ColumnLayout_file_extension "bin"
#endif
#ifndef io_ascham_flatbuf_LayoutDescriptor_file_identifier
#define io_ascham_flatbuf_LayoutDescriptor_file_identifier "ALD2"
#endif
/* deprecated, use io_ascham_flatbuf_LayoutDescriptor_file_identifier */
#ifndef io_ascham_flatbuf_LayoutDescriptor_identifier
#define io_ascham_flatbuf_LayoutDescriptor_identifier "ALD2"
#endif
#define io_ascham_flatbuf_LayoutDescriptor_type_hash ((flatbuffers_thash_t)0x691e9ba7)
#define io_ascham_flatbuf_LayoutDescriptor_type_identifier "\xa7\x9b\x1e\x69"
#ifndef io_ascham_flatbuf_LayoutDescriptor_file_extension
#define io_ascham_flatbuf_LayoutDescriptor_file_extension "bin"
#endif
...
typedef int8_t io_ascham_flatbuf_PhysicalKind_enum_t;
__flatbuffers_define_integer_type(io_ascham_flatbuf_PhysicalKind, io_ascham_flatbuf_PhysicalKind_enum_t, 8)
/**  Fixed-width primitive: validity bitmap + a width*rows data buffer. */
#define io_ascham_flatbuf_PhysicalKind_Fixed ((io_ascham_flatbuf_PhysicalKind_enum_t)INT8_C(0))
#define io_ascham_flatbuf_PhysicalKind_Varlen ((io_ascham_flatbuf_PhysicalKind_enum_t)INT8_C(1))
#define io_ascham_flatbuf_PhysicalKind_BoolBitmap ((io_ascham_flatbuf_PhysicalKind_enum_t)INT8_C(2))

static inline const char *io_ascham_flatbuf_PhysicalKind_name(io_ascham_flatbuf_PhysicalKind_enum_t value)
{
    switch (value) {
    case io_ascham_flatbuf_PhysicalKind_Fixed: return "Fixed";
    case io_ascham_flatbuf_PhysicalKind_Varlen: return "Varlen";
    case io_ascham_flatbuf_PhysicalKind_BoolBitmap: return "BoolBitmap";
    default: return "";
    }
}

static inline int io_ascham_flatbuf_PhysicalKind_is_known_value(io_ascham_flatbuf_PhysicalKind_enum_t value)
{
    switch (value) {
    case io_ascham_flatbuf_PhysicalKind_Fixed: return 1;
    case io_ascham_flatbuf_PhysicalKind_Varlen: return 1;
    case io_ascham_flatbuf_PhysicalKind_BoolBitmap: return 1;
    default: return 0;
    }
}
 ...
 *  (spec invariant 5). */
struct io_ascham_flatbuf_ColumnLayout_table { uint8_t unused__; };

static inline size_t io_ascham_flatbuf_ColumnLayout_vec_len(io_ascham_flatbuf_ColumnLayout_vec_t vec)
__flatbuffers_vec_len(vec)
static inline io_ascham_flatbuf_ColumnLayout_table_t io_ascham_flatbuf_ColumnLayout_vec_at(io_ascham_flatbuf_ColumnLayout_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(io_ascham_flatbuf_ColumnLayout_table_t, vec, i, 0)
__flatbuffers_table_as_root(io_ascham_flatbuf_ColumnLayout)

/**  Arrow field name. */
__flatbuffers_define_string_field(0, io_ascham_flatbuf_ColumnLayout, name, 1)
/**  Schema position. */
__flatbuffers_define_scalar_field(1, io_ascham_flatbuf_ColumnLayout, ordinal, flatbuffers_int32, int32_t, INT32_C(0))
__flatbuffers_define_scalar_field(2, io_ascham_flatbuf_ColumnLayout, kind, io_ascham_flatbuf_PhysicalKind, io_ascham_flatbuf_PhysicalKind_enum_t, INT8_C(0))
/**  Index into LayoutDescriptor.families. */
__flatbuffers_define_scalar_field(3, io_ascham_flatbuf_ColumnLayout, family_id, flatbuffers_int32, int32_t, INT32_C(0))
/**  Fixed element byte width; 0 for Varlen/BoolBitmap. */
__flatbuffers_define_scalar_field(4, io_ascham_flatbuf_ColumnLayout, element_width, flatbuffers_int32, int32_t, INT32_C(0))
__flatbuffers_define_scalar_field(5, io_ascham_flatbuf_ColumnLayout, validity_offset, flatbuffers_int64, int64_t, INT64_C(0))
/**  Varlen: the byte data buffer. */
__flatbuffers_define_scalar_field(6, io_ascham_flatbuf_ColumnLayout, data_offset, flatbuffers_int64, int64_t, INT64_C(0))
__flatbuffers_define_scalar_field(7, io_ascham_flatbuf_ColumnLayout, data_capacity_bytes, flatbuffers_int64, int64_t, INT64_C(0))
/**  -1 = not varlen (sentinel preserved as the field default). */
__flatbuffers_define_scalar_field(8, io_ascham_flatbuf_ColumnLayout, offsets_offset, flatbuffers_int64, int64_t, INT64_C(-1))
/**  ascham.varlen_bytes; 0 if not varlen. */
__flatbuffers_define_scalar_field(9, io_ascham_flatbuf_ColumnLayout, varlen_capacity_bytes, flatbuffers_int64, int64_t, INT64_C(0))

struct io_ascham_flatbuf_LayoutDescriptor_table { uint8_t unused__; };

static inline size_t io_ascham_flatbuf_LayoutDescriptor_vec_len(io_ascham_flatbuf_LayoutDescriptor_vec_t vec)
__flatbuffers_vec_len(vec)
static inline io_ascham_flatbuf_LayoutDescriptor_table_t io_ascham_flatbuf_LayoutDescriptor_vec_at(io_ascham_flatbuf_LayoutDescriptor_vec_t vec, size_t i)
__flatbuffers_offset_vec_at(io_ascham_flatbuf_LayoutDescriptor_table_t, vec, i, 0)
__flatbuffers_table_as_root(io_ascham_flatbuf_LayoutDescriptor)

/**  Must equal the header's batch_rows field (readers cross-check). */
__flatbuffers_define_scalar_field(0, io_ascham_flatbuf_LayoutDescriptor, batch_rows, flatbuffers_int32, int32_t, INT32_C(0))
/**  Must equal the header's batch_stride field (readers cross-check). */
__flatbuffers_define_scalar_field(1, io_ascham_flatbuf_LayoutDescriptor, batch_stride_bytes, flatbuffers_int64, int64_t, INT64_C(0))
/**  Family names, indexed by ColumnLayout.family_id (spec invariant 8). */
__flatbuffers_define_vector_field(2, io_ascham_flatbuf_LayoutDescriptor, families, flatbuffers_string_vec_t, 1)
/**  One entry per column, in schema ordinal order. */
__flatbuffers_define_vector_field(3, io_ascham_flatbuf_LayoutDescriptor, columns, io_ascham_flatbuf_ColumnLayout_vec_t, 1)


#include "flatcc/flatcc_epilogue.h"
#endif /* LAYOUT_READER_H */
#ifndef LAYOUT_VERIFIER_H
#define LAYOUT_VERIFIER_H
...
static int io_ascham_flatbuf_ColumnLayout_verify_table(flatcc_table_verifier_descriptor_t *td);
static int io_ascham_flatbuf_LayoutDescriptor_verify_table(flatcc_table_verifier_descriptor_t *td);

static int io_ascham_flatbuf_ColumnLayout_verify_table(flatcc_table_verifier_descriptor_t *td)
{
    int ret;
    if ((ret = flatcc_verify_string_field(td, 0, 1) /* name */)) return ret;
    if ((ret = flatcc_verify_field(td, 1, 4, 4) /* ordinal */)) return ret;
    if ((ret = flatcc_verify_field(td, 2, 1, 1) /* kind */)) return ret;
    if ((ret = flatcc_verify_field(td, 3, 4, 4) /* family_id */)) return ret;
    if ((ret = flatcc_verify_field(td, 4, 4, 4) /* element_width */)) return ret;
    if ((ret = flatcc_verify_field(td, 5, 8, 8) /* validity_offset */)) return ret;
    if ((ret = flatcc_verify_field(td, 6, 8, 8) /* data_offset */)) return ret;
    if ((ret = flatcc_verify_field(td, 7, 8, 8) /* data_capacity_bytes */)) return ret;
    if ((ret = flatcc_verify_field(td, 8, 8, 8) /* offsets_offset */)) return ret;
    if ((ret = flatcc_verify_field(td, 9, 8, 8) /* varlen_capacity_bytes */)) return ret;
    return flatcc_verify_ok;
}

static inline int io_ascham_flatbuf_ColumnLayout_verify_as_root(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root(buf, bufsiz, io_ascham_flatbuf_ColumnLayout_identifier, &io_ascham_flatbuf_ColumnLayout_verify_table);
}

static inline int io_ascham_flatbuf_ColumnLayout_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, io_ascham_flatbuf_ColumnLayout_identifier, &io_ascham_flatbuf_ColumnLayout_verify_table);
}

static inline int io_ascham_flatbuf_ColumnLayout_verify_as_typed_root(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root(buf, bufsiz, io_ascham_flatbuf_ColumnLayout_type_identifier, &io_ascham_flatbuf_ColumnLayout_verify_table);
}

static inline int io_ascham_flatbuf_ColumnLayout_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, io_ascham_flatbuf_ColumnLayout_type_identifier, &io_ascham_flatbuf_ColumnLayout_verify_table);
}

static inline int io_ascham_flatbuf_ColumnLayout_verify_as_root_with_identifier(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root(buf, bufsiz, fid, &io_ascham_flatbuf_ColumnLayout_verify_table);
}

static inline int io_ascham_flatbuf_ColumnLayout_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &io_ascham_flatbuf_ColumnLayout_verify_table);
}

static inline int io_ascham_flatbuf_ColumnLayout_verify_as_root_with_type_hash(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &io_ascham_flatbuf_ColumnLayout_verify_table);
}

static inline int io_ascham_flatbuf_ColumnLayout_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &io_ascham_flatbuf_ColumnLayout_verify_table);
}

static int io_ascham_flatbuf_LayoutDescriptor_verify_table(flatcc_table_verifier_descriptor_t *td)
{
    int ret;
    if ((ret = flatcc_verify_field(td, 0, 4, 4) /* batch_rows */)) return ret;
    if ((ret = flatcc_verify_field(td, 1, 8, 8) /* batch_stride_bytes */)) return ret;
    if ((ret = flatcc_verify_string_vector_field(td, 2, 1) /* families */)) return ret;
    if ((ret = flatcc_verify_table_vector_field(td, 3, 1, &io_ascham_flatbuf_ColumnLayout_verify_table) /* columns */)) return ret;
    return flatcc_verify_ok;
}

static inline int io_ascham_flatbuf_LayoutDescriptor_verify_as_root(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root(buf, bufsiz, io_ascham_flatbuf_LayoutDescriptor_identifier, &io_ascham_flatbuf_LayoutDescriptor_verify_table);
}

static inline int io_ascham_flatbuf_LayoutDescriptor_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, io_ascham_flatbuf_LayoutDescriptor_identifier, &io_ascham_flatbuf_LayoutDescriptor_verify_table);
}

static inline int io_ascham_flatbuf_LayoutDescriptor_verify_as_typed_root(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root(buf, bufsiz, io_ascham_flatbuf_LayoutDescriptor_type_identifier, &io_ascham_flatbuf_LayoutDescriptor_verify_table);
}

static inline int io_ascham_flatbuf_LayoutDescriptor_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, io_ascham_flatbuf_LayoutDescriptor_type_identifier, &io_ascham_flatbuf_LayoutDescriptor_verify_table);
}

static inline int io_ascham_flatbuf_LayoutDescriptor_verify_as_root_with_identifier(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root(buf, bufsiz, fid, &io_ascham_flatbuf_LayoutDescriptor_verify_table);
}

static inline int io_ascham_flatbuf_LayoutDescriptor_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &io_ascham_flatbuf_LayoutDescriptor_verify_table);
}

static inline int io_ascham_flatbuf_LayoutDescriptor_verify_as_root_with_type_hash(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &io_ascham_flatbuf_LayoutDescriptor_verify_table);
}

static inline int io_ascham_flatbuf_LayoutDescriptor_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &io_ascham_flatbuf_LayoutDescriptor_verify_table);
}

#include "flatcc/flatcc_epilogue.h"
#endif /* LAYOUT_VERIFIER_H */
